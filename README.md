...
- **A graphical desktop** — double-buffered window manager (resize, Aero snap, rounded corners), taskbar with system tray and clickable window buttons (minimize/restore, hover-highlighted, v38.39), draggable persistent icons, and a graphical login screen.
