...
- **FAT32** — third drive (secondary slave, `index=3`), mounted at `/fat32`: BPB parsing, FAT cluster-chain traversal, 8.3 SFN dirent read/write (LFN skipped), cluster allocation/free on write/create/delete, whole-tree rebuild at mount; volumes created by host `mkfs.fat`/mtools work both ways.
