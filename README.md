...
**App runtime & tooling (v38.3, v38.13, v38.24)**
...
CI (`.github/workflows/build-boot-test.yml`) runs every suite above on each push: boot, fork, jobcontrol, KVM fork, FAT32, poll/select, fuzz, page cache, app smoke tests, mmap, Rust, lseek, panic, permissions, TLS/clone, and multi-sector PIO.
