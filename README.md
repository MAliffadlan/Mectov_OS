# Mectov OS v35.2 — Shell File Management & Ext2 Hardening Update
...
The v35.2 release rounds out shell file management with `cp`, `mv`, `rmdir` and `df`, and hardens the ext2 write layer with two on-disk consistency fixes found while exercising delete/rename. The recent changes are:
