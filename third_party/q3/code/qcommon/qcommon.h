...
#ifdef ZONE_DEBUG
#define Q3Z_TagMalloc(size, tag)			Q3Z_TagMallocDebug(size, tag, #size, __FILE__, __LINE__)
#define Q3Z_Malloc(size)					Q3Z_MallocDebug(size, #size, __FILE__, __LINE__)
#define S_Malloc(size)					S_MallocDebug(size, #size, __FILE__, __LINE__)
void *Q3Z_TagMallocDebug( int size, int tag, char *label, char *file, int line );	// NOT 0 filled memory
void *Q3Z_MallocDebug( int size, char *label, char *file, int line );			// returns 0 filled memory
void *S_MallocDebug( int size, char *label, char *file, int line );			// returns 0 filled memory
#else
void *Q3Z_TagMalloc( int size, int tag );	// NOT 0 filled memory
void *Q3Z_Malloc( int size );			// returns 0 filled memory
